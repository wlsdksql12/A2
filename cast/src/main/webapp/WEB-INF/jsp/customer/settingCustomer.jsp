						...
						<div class="col-sm-12">
							<div class="card support-bar overflow-hidden">
								...
								<div class="container-fluid">
										...
										<form id="deleteForm" method="post" action="${pageContext.request.contextPath}/deleteCustomer">
								...
								<div class="float-right">
									<a class="btn btn-outline-primary" href="${pageContext.request.contextPath}/updatePw?customerId=${loginCustomerId}">비밀번호 변경</a>
