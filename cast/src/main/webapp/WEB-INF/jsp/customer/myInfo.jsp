					...
					<div class="row align-items-center">
						<div class="col-md-12">
							<div class="page-header-title">
								<h3 style="color: white;" class="m-b-10">MyInfo</h3>
							</div>
							<ul class="breadcrumb">
	...
	<!-- 메인컨텐츠 start -->
			<div class="row">
				<div class="col-lg-12 col-md-24">
						...
						<div class="col-sm-6">
							<div class="card support-bar overflow-hidden">
								...
								<div class="card-footer bg-primary text-white">
									<div>
										<div class="col">
											<h4 class="m-0 text-white">${customerId}</h4>
											<div></div>
										</div>
									</div>
								</div>
						...
						<div class="col-sm-6">
							<div class="card support-bar overflow-hidden">
								...
								<div class="card-footer bg-primary text-white">
									<div>
										<div class="col">
											<h4 class="m-0 text-white">${customerName}</h4>
											<div></div>
										</div>
									</div>
								</div>
						...
						<div class="col-sm-6">
							<div class="card support-bar overflow-hidden">
								...
								<div class="card-footer bg-primary text-white">
									<div>
										<div class="col">
											<h4 class="m-0 text-white">${customerJumin}</h4>
											<div></div>
										</div>
									</div>
								</div>
						...
						<div class="col-sm-6">
							<div class="card support-bar overflow-hidden">
								...
								<div class="card-footer bg-primary text-white">
									<div>
										<div class="col">
											<h4 class="m-0 text-white">${customerEmail}</h4>
											<div></div>
										</div>
									</div>
								</div>
						...
						<div class="col-sm-6">
							<div class="card support-bar overflow-hidden">
								...
								<div class="card-footer bg-primary text-white">
									<div>
										<div class="col">
											<h4 class="m-0 text-white">${customerPhoneNum }</h4>
											<div></div>
										</div>
									</div>
								</div>
					...
					<a href="${pageContext.request.contextPath}/updateInfo?customerId=${customerId}" id="updateBtn" class="float-right btn btn-outline-primary">수정</a>
				</div>
			</div>
			<!-- 메인컨텐츠 end -->
