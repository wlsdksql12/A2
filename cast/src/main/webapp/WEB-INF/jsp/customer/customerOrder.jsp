								...
								<div class="card-body pb-0">
									...
									<div class="container-fluid">
										...
										<c:if test="${currentPage > 1}">
											<a href="${pageContext.request.contextPath}/CustomerOrderList?customerId=${loginCustomerId}&currentPage=${currentPage-1}&currentPage2=${currentPage2}">이전</a>
										</c:if>
										<c:if test="${currentPage < lastPage}">
											<a href="${pageContext.request.contextPath}/CustomerOrderList?customerId=${loginCustomerId}&currentPage=${currentPage+1}&currentPage2=${currentPage2}">다음</a>
										</c:if>
									</div>
								</div>
							</div>
