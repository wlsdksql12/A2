					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card support-bar overflow-hidden">
								...
								<form id="updateQnaForm" method="post" action="${pageContext.request.contextPath}/updateQna">
						...
						<a class="float-right btn btn-outline-primary" href="${pageContext.request.contextPath}/customer/qnaListOne?qnaId=${qnaId}&customerId=${customerId}">이전 페이지</a>
					</form>
						</div>
					</div>
				</div>
