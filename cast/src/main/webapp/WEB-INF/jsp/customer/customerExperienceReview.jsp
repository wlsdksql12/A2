					...
					<div class="row align-items-center">
						<div class="col-md-12">
							<div class="page-header-title">
								<h3 style="color: white;" class="m-b-10">체험&숙소 후기</h3>
							</div>
							<ul class="breadcrumb">
								...
								<div class="card-body pb-0">
									...
									<div class="container-fluid">
										...
										<table class="table table-bordered">
											...
											<c:forEach items="${ExperienceReviewList1}"  var="list1">
											<tr>
												<td>${list1.experienceOrder.experienceName}</td>								
												<td>${list1.experiencePaymentReviewContent}</td>
												<td>${list1.createDate}</td>
												<td>${list1.updateDate}</td>
											</tr>
											</c:forEach>
										</table>
