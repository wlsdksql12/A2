														...
														<td>
															...
															<div class="d-inline-block align-middle">
																...
																<div class="d-inline-block">
																	<h6>
																		<a
																			href="${pageContext.request.contextPath}/mainRoomSelectOne?roomSelectId=${list.roomSelect.roomSelectId}">${list.roomSelect.roomSelectTitle}</a>
																	</h6>
																</div>
															</div>
														</td>
														<td>${list.roomSelect.travelerId}</td>
														<td>${list.roomSelectCommentId}</td>
														<td>${list.roomSelectContent}</td>
