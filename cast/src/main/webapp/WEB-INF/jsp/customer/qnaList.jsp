									...
									<div class="table-responsive">
														...
														<td>
															...
															<div class="d-inline-block align-middle">
																...
																<div class="d-inline-block">
																	<h6>
																		<a
																			href="${pageContext.request.contextPath}/customer/qnaListOne?qnaId=${qna.qnaId}&customerId=${loginCustomerId}">${qna.qnaTitle}</a>
																	</h6>
																</div>
															</div>
														</td>
										...
										<div style="text-align: center;" class="table container mt-3">
											<c:if test="${currentPage > 1}">
												<a
													href="${pageContext.request.contextPath}/qnaList?customerId=${loginCustomerId}&currentPage=${currentPage-1}">이전</a>
											</c:if>
											<c:if test="${currentPage < lastPage}">
												<a
													href="${pageContext.request.contextPath}/qnaList?customerId=${loginCustomerId}&currentPage=${currentPage+1}">다음</a>
											</c:if>
										</div>
									</div>
								</div>
