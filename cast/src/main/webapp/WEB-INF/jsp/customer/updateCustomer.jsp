						...
						<div class="col-sm-12">
							<div class="card support-bar overflow-hidden">
								...
								<div class="container-fluid">
									<form id="updatePwForm" method="post" action="${pageContext.request.contextPath}/updatePw">
										<!--  회원 아이디 히든으로... -->
										...
										<table class="table table-bordered">
											...
											<tr>
												<td>새 비밀번호</td>
												<td>
													<input type="password" id="newCustomerPw" name="newCustomerPw">
												</td>
											</tr>
										</table>
								</div>
							...
							<div class="float-right">
							<button id="updatePwBtn" class="btn btn-outline-primary" type="button">수정</button>
							</div>
							</form>
						</div>
					</div>
