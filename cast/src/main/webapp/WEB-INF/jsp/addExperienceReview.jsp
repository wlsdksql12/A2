   ...
   <%@ include file="/WEB-INF/jsp/header.jsp"%>
    ...
    <section class="container py-5">
		<form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/addExperienceReview">
			<input type="hidden" name="experiencePaymentId" value="${experiencePaymentId}" readonly="readonly">
			<input type="hidden" name="experienceId" value="${experienceId}"readonly="readonly">
			<h2>체험 후기</h2>
			<table class="table table-bordered">
				...
				<tr>
					<td>내용</td>
					<td>
						<textarea style="resize: none;" rows="5" cols="100" name="experiencePaymentReviewContent"></textarea>
					</td>
				</tr>
			</table>
			<div>
				<button class="btn btn-outline-success" type="submit">추가</button>
				<a class="btn btn-outline-success" href="mainExperienceOne?experienceId=${experienceId}&currentPage=1">이전</a>
			</div>
		</form>
	</section>
    <!-- End Section -->
