   	...
   	<div style="text-align:center">
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td style="text-align: left;">
					<textarea id="experienceSelectContent" style="width: 1000px; height: 300px; resize: none; border: none;" name="experienceSelectContent"></textarea>
					<input type="hidden" name ="experienceSelectId" value="${experienceSelectId}">
				</td>
			</tr>
		</table>
		<div style="text-align: right;">
			<button id="insertCommentBtn" class="btn btn-outline-success" type="button">입력</button>
		</div>
		</form>
	</div>
