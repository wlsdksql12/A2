                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      ...
                      <th class="px-4 py-4" width="20%">정보</th>
                  ...
                  >
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="py-4 py-4 text-sm" width="40%">
                        <a href= "${pageContext.request.contextPath}/mainHotelOne?hotelId=${hotel.hotelId}">${hotel.hotelName}</a>
                      </td>
                      <td class="px-4 py-4 text-sm" width="20%">
                          ${hotel.hotelContent}
                      </td>
                      <td class="px-7 py-6 text-sm" width="20%">
                        ${hotel.createDate.substring(0,10)}
                      </td>
                    </tr>
                    </c:forEach>
                  </tbody>
                ...
                <table class="w-full whitespace-no-wrap">
                  ...
                  >
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="py-4 py-4 text-sm" width="40%">
                        <a href= "${pageContext.request.contextPath}/mainExperienceOne?experienceId=${experience.experienceId}">${experience.experienceName}</a>
                      </td>
                      <td class="px-4 py-4 text-sm" width="20%">
                          ${experience.experienceContent}
                      </td>
                      <td class="px-7 py-6 text-sm" width="20%">
                        ${experience.createDate.substring(0,10)}
                      </td>
                    </tr>
                    </c:forEach>
                  </tbody>
