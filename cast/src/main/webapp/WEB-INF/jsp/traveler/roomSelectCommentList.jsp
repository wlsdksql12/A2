...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
  <head>
    ...
    <title>[여행작가]내 숙소 추천 댓글 리스트!</title>
    <link
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            ...
            <a
              ...
              href="${pageContext.request.contextPath}/mainRoomSelect"
            >
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  >
					<c:forEach items="${roomSelectCommentList}" var="roomSelectComment">
              ...
              <div>
                ...
                <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
					<c:if test="${startPage > 1}">
						<a href="${pageContext.request.contextPath}/roomSelectCommentList?travelerId=${loginTravelerId}&currentPage=${startPage-1}" class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple">처음</a>
					</c:if>
					<c:forEach begin="${startPage}" end="${lastPage}" var="i">
						<c:choose>
							<c:when test="${i == currentPage}">
								<a href="${pageContext.request.contextPath}/roomSelectCommentList?travelerId=${loginTravelerId}&currentPage=${i}" class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple">${i}</a>
							</c:when>
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/roomSelectCommentList?travelerId=${loginTravelerId}&currentPage=${i}" class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple">${i}</a>
							</c:otherwise>
					...
					<c:if test="${lastPage != totalPage}">
						<a href="${pageContext.request.contextPath}/roomSelectCommentList?travelerId=${loginTravelerId}&currentPage=${lastPage+1}" class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple">끝</a>
					</c:if>
                </span>
              </div>
            </div>
