...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
  <head>
    ...
    <title>[여행작가]내 체험 추천 댓글 리스트!</title>
    <link
      href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
      rel="stylesheet"
    />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/traveler_template/css/tailwind.output.css" />
    <script
           ...
           <li class="relative px-6 py-3">
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  >
                    <a class="w-full" href="${pageContext.request.contextPath}/travelerLogout">로그아웃</a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="${pageContext.request.contextPath}/travelerMyInfo?travelerId=${loginTravelerId}">	
                      프로필
                    </a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="${pageContext.request.contextPath}/modifyTravelerMyInfo?travelerId=${loginTravelerId}">
                      정보수정
                    </a>
                  </li>
                   <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="${pageContext.request.contextPath}/modifyTravelerPw?travelerId=${loginTravelerId}">
                      비밀번호 변경
                    </a>
                  </li>
                   <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="${pageContext.request.contextPath}/removeTraveler?travelerId=${loginTravelerId}">
                      회원탈퇴
                    </a>
                  </li>
                </ul>
          ...
          <li class="relative px-6 py-3">
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">내 숙소 추천 댓글</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
              ...
              <li class="relative">
                ...
                <template x-if="isNotificationsMenuOpen">
                  ...
                  >
                    <li>
                    	<span class="row-fluid" style="width:100%; height:50px; text-align:center;">숙소 추천 댓글</span>
                    	<hr><br>
                    	<c:forEach items="${roomSelectAlarmList}" var="roomSelect">
                    	<div class="row-fluid" style="width:100%; height:50px; text-align:center;">
                      	<a
                        	...
                        	href="${pageContext.request.contextPath}/mainRoomSelectOne?roomSelectId=${roomSelect.roomSelectId}">
                        	${roomSelect.roomSelectContent}
                      	</a>
                      	</div> 
                       	</c:forEach>
                     </li> 	
                     <li>
                     	<span class="row-fluid" style="width:100%; height:50px; text-align:center;">체험 추천 댓글</span>
                    	<hr><br>                
                       	<c:forEach items="${experienceSelectAlarmList}" var="experienceSelect">
                       	<div class="row-fluid" style="width:100%; height:50px; text-align:center;">      
                      	<a
                        	class="text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
              ...
              <li class="relative">
                ...
                >
                  <img
                    ...
                    src="${pageContext.request.contextPath}/resources/traveler_template/img/person.JPG"
                    alt=""
                    aria-hidden="true"
                  />
                </button>
                  ...
                  >
                    <li class="flex">
                      <a
                        ...
                        href="${pageContext.request.contextPath}/travelerMyInfo?travelerId=${loginTravelerId}"
                      >
                        <svg
                          class="w-4 h-4 mr-3"
                          aria-hidden="true"
                    ...
                    <li class="flex">
                      <a
                        class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                        href="${pageContext.request.contextPath}/modifyTravelerMyInfo?travelerId=${loginTravelerId}"
                      >
                        <svg
                          class="w-4 h-4 mr-3"
                          aria-hidden="true"
                    ...
                    <li class="flex">
                      <a
                        class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                        href="${pageContext.request.contextPath}/travelerLogout"
                      >
                        <svg
                          class="w-4 h-4 mr-3"
                          aria-hidden="true"
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            ...
            <a
              ...
              href="${pageContext.request.contextPath}/mainExperienceSelect"
            >
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  >
					<c:forEach items="${experienceSelectCommentList}" var="experienceSelectComment">
              ...
              <div>
                ...
                <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
					<c:if test="${startPage > 1}">
						<a href="${pageContext.request.contextPath}/experienceSelectCommentList?travelerId=${loginTravelerId}&currentPage=${startPage-1}" class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple">처음</a>
					</c:if>
					<c:forEach begin="${startPage}" end="${lastPage}" var="i">
						<c:choose>
							<c:when test="${i == currentPage}">
								<a href="${pageContext.request.contextPath}/experienceSelectCommentList?travelerId=${loginTravelerId}&currentPage=${i}" class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple">${i}</a>
							</c:when>
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/experienceSelectCommentList?travelerId=${loginTravelerId}&currentPage=${i}" class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple">${i}</a>
							</c:otherwise>
					...
					<c:if test="${lastPage != totalPage}">
						<a href="${pageContext.request.contextPath}/experienceSelectCommentList?travelerId=${loginTravelerId}&currentPage=${lastPage+1}" class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple">끝</a>
					</c:if>
                </span>
              </div>
            </div>
