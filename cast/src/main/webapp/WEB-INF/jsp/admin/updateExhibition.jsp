  ...
  <div id="wrapper">
	...
	<div class="card">
      ...
      <div class="table-responsive">
		 <form method="post" action="/admin/updateExhibition">
			...
			<table class="table align-items-center table-flush">
				<tr>
					...
					<td width="80%"><input type="text" name="exhibitionTitle" style="width:685px; text-align: center" value="${exhibition.exhibitionTitle}"></td>
				</tr>
				<tbody>
					<tr>
						<td style="text-align: right">내용</td>
						<td><textarea name="exhibitionContent" rows="10" cols="80">${exhibition.exhibitionContent}</textarea></td>
					</tr>
				</tbody>
			</table>
