...
<body id="page-top">
  <div id="wrapper">
	...
	<div class="card">
      ...
      <div class="table-responsive">
		 <form method="post" action="${pageContext.request.contextPath}/admin/updateNotice" id="updateNoticeForm">
			...
			<button id="updateNoticeBtn" type="button" class="btn btn-outline-success">수정하기</button>
		</form>
		<br>
	</div>
</div>
  ...
  $(function(){
		...
		$('#updateNoticeForm').keypress(function(event){
			if(event.which == 13) {
				$('#updateNoticeBtn').click();
				return false;
			}
		});
	  });
