...
<body>
   ...
   <%@ include file="/WEB-INF/jsp/header.jsp"%>
    ...
    <form id="updateMainRoomForm" method="post" action="${pageContext.request.contextPath}/updateMainRoomSelectComment">
 	<input type="hidden" name="roomSelectCommentId" value="${roomSelectCommentId }">
	...
	<input type="hidden" name="roomSelectId" value="${roomSelectId}">
 	<table class="table table-bordered">
 		...
 		<tr>
 			...
 			<td>
 				<textarea style="width: 1000px; height: 300px; resize: none; border: none;" id="roomSelectContent" name="roomSelectContent"></textarea>
 			</td>
 		</tr>
 	</table>
 	<div style="text-align: right;">
		<button class="btn btn-outline-success" type="button" id="updateCommentBtn">수정</button>
	...
	$(function(){
		$('#updateCommentBtn').click(function(){
			if($('#roomSelectContent').val() == ""){
				alert("수정한 내용을 입력하세요");
				$('#roomSelectContent').focus();
				return false;
			}
			else {
				$('#updateMainRoomForm').submit();
			}
		});
	});
	</script>
