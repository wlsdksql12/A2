          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <img class="img-profile rounded-circle" src="${pageContext.request.contextPath}/resources/admin_template/img/boy.png" style="max-width: 60px">
	...
	<div class="card">
      ...
      <div class="table-responsive">
		...
		<c:if test="${loginAdminId != null}">
			<div>
				<a href="${pageContext.request.contextPath}/admin/updateExhibition?exhibitionNo=${exhibition.exhibitionNo}" class="btn btn-outline-success">수정하기</a>
				<a href="${pageContext.request.contextPath}/admin/deleteExhibition?exhibitionNo=${exhibition.exhibitionNo}" class="btn btn-outline-success">삭제하기</a>
			</div>
		</c:if>
		<br>
	</div>
