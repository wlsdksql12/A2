	...
	<section class="container py-5">
		...
		<div class="container">
			...
			<c:if test="${loginCustomerId == customerId}">
				<a href="/updateQna?qnaId=${qnaId}&customerId=${customerId}"
			...
			<div style="text-align: right;">
				<input type="button" value="이전페이지" onclick="history.back(-1)">
			</div>
			<h1>Qna 답변</h1>
	...
	<footer class="bg-dark" id="tempaltemo_footer">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 pt-5">
					<h2 class="h2 text-success border-bottom pb-3 border-light logo">Cast
						Shop</h2>
				...
				<div class="col-auto me-auto">
					<ul class="list-inline text-left footer-icons">
						<li
							...
							target="_blank" href="http://fb.com/templatemo"><i
		...
		<div class="w-100 bg-black py-3">
			<div class="container">
				<div class="row pt-2">
					<div class="col-12">
						<p class="text-left text-light">&copy; 2021 CAST</p>
					</div>
				</div>
			</div>
		</div>
