		...
		<form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/addHotelReview">
			...
			<table class="table table-bordered">
				...
				<tr>
					<td>내용</td>
					<td>
						<textarea style="resize: none;" rows="5" cols="100" name="roomPaymentReviewContent"></textarea>
					</td>
				</tr>
			</table>
			<div>
				<button class="btn btn-outline-success" type="submit">추가</button>
				<a class="btn btn-outline-success" href="mainHotelOne?hotelId=${hotelId}&currentPage=1">이전</a>
			</div>
		</form>
	</section>
    <!-- End Section -->
