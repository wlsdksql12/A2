    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                 <c:forEach items="${selectThemeShopList}" var="ThemeShopList">
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <a href="/mainExperienceOne?experienceId=${ThemeShopList.experience.experienceId}" class="h3 text-decoration-none">${ThemeShopList.experience.experienceName}</a>
                                ...
                                <p class="text-center mb-0">${ThemeShopList.experience.experiencePrice}원</p>
                            </div>
                        </div>
                    </div>
                   </c:forEach>
