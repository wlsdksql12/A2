    ...
    <section class="container py-5">
		...
		<table class="text-center table table-striped">
			...
			<tr>
				<td>호텔 이름</td>
				<td>
					<input style="border:none;" type="text" name="hotelName" value="${hotelName}" readonly="readonly">
				</td>
			</tr>
			<tr>
				<td>방 이름</td>
				<td>
					<input style="border:none;" type="text" name="roomName" value="${roomName}" readonly="readonly">
				</td>
			</tr>
			<tr>
				<td>예약 인원 수</td>
				<td>
					<input style="border:none;" type="text" name="roomOrderPeople">
				</td>
			</tr>
			<tr>
				<td>예약 시작 일자</td>
				<td>
					<input style="border:none;" type="date" name="roomOrderStartDate">
				</td>
			</tr>
			<tr>
				<td>예약 종료 일자</td>
				<td>
					<input style="border:none;" type="date" name="roomOrderEndDate">
				</td>
			</tr>
			<tr>
				<td>옵션</td>
				<td>
					<textarea style="resize:none; border:none;" rows="15" cols="30" name="note" readonly="readonly">${note}</textarea>
				</td>
			</tr>
		</table>
		<div style="text-align: right;">
			<button class="btn btn-outline-success" type="submit">예약</button>
		</div>
		</form>
    </section>
    <!-- End Section -->
